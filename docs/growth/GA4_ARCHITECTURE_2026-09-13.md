...
## Live tag routing correction

Loader and config use shared Google tag G-TZ9B8MB7SP, as prescribed by GA's installation UI. Explicit events use send_to G-RVHFFPF0W1. NEXT_PUBLIC_GA_TAG_ID must exactly match the shared ID for activation. The measurement ID alone returned a 404 loader. September 13 live HAR verified accepted events to the intended destination with safe contexts; details and limits are in GA4_ACCOUNT_CHECK_2026-09-13.md.
