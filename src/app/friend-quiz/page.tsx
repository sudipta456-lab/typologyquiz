...
// Breadcrumb only. The /friend-quiz/play/ pages carry someone's own answers in
// the URL and are noindex, so nothing here describes them as content.
const JSON_LD = jsonLdGraph([
  breadcrumbList([
    { name: "Home", path: "/" },
    { name: "Friend quiz", path: "/friend-quiz/" },
  ]),
]);
